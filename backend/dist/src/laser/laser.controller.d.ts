...
export declare class LaserController {
    private laserService;
    constructor(laserService: LaserService);
    ...
    addPhoto(id: string, tenantId: string, dto: AddSessionPhotoDto): Promise<{
        type: import(".prisma/client").$Enums.DocumentType;
        id: string;
        createdAt: Date;
        fileUrl: string;
    ...
    removePhoto(sessionId: string, photoId: string, tenantId: string): Promise<{
        message: string;
    }>;
}
